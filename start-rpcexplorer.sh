...
-c "n use 9.11.2" --max-old-space-size=$BTCEXP_OLD_SPACE_MAX_SIZE ./bin/cli.js --max-mem $BTCEXP_OLD_SPACE_MAX_SIZE -i 127.0.0.1 -p 8080 -C LONG -H 127.0.0.1 -P 8878 -u user -w password -E standalone
